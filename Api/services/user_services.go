...
type userService struct {
	...
	tokenGenerator jwtUtils.JWTGenerator
}

var ErrInvalidPassword = errors.New("invalid password")

func NewUserService(repo repo.UserRepository, hasher utils.BcryptHasher, tokenGen jwtUtils.JWTGenerator, logger *logrus.Logger) *userService {
	return &userService{
		repo:           repo,
		hasher:         hasher,
